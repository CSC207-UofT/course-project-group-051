...
via methods and variable names. Additionally, we are aware that our Phase1.Users class is overloaded, but we need
to ask our TA for advice on cleanly splitting up our Phase1.Users entity into 2 entities.
...
* How do we efficiently split up an overloaded entity class (Phase1.Users) without losing clean architecture?
