...
public void createNewUser(Database database, String firstName, String lastName, Date DOB, String Occupation, BufferedImage profilePic,
                          ArrayList<String> hobbies, String bio, String gender, String orientation, String userID, String pw) {
    User u = new User(firstName, lastName, DOB, Occupation, profilePic, hobbies, bio, gender, orientation, userID, pw);
